...
func (c *ServiceCache) AllFrozen() []FrozenEntry {
	...
	// ⚡ Bolt: Using slices.SortFunc with cmp.Compare is faster and produces zero memory allocations compared to sort.Slice because it utilizes generics instead of reflection.
