...
func (c *ServiceCache) AllFrozen() []FrozenEntry {
	...
	// ⚡ Bolt: Using slices.SortFunc with cmp.Compare eliminates reflection overhead
	// present in sort.Slice, significantly speeding up sorting and zeroing allocations.
