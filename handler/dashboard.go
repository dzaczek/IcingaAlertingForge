      ...
      <div class="lcars-panel tan">
        ...
        <div class="lcars-panel-body">
          ...
          <div class="table-filter">
            <input type="text" id="filterAlerts" placeholder="Filter alerts..." oninput="debounceFilter('alertsTable', this.value, 'filterAlertsCount')">
    ...
    <div class="nav-section" id="sec-services">
      <div class="lcars-panel blue">
        ...
        <div class="lcars-panel-body">
          {{if .CachedServices}}
          <div class="table-filter">
            <input type="text" id="filterServices" placeholder="Filter services..." oninput="debounceFilter('svcRegistryTable', this.value, 'filterServicesCount')">
    ...
    <div class="nav-section" id="sec-icinga">
      <div class="lcars-panel">
        ...
        <div class="lcars-panel-body">
          {{if .IcingaServices}}
          <div class="table-filter">
            <input type="text" id="filterIcinga" placeholder="Filter Icinga services..." oninput="debounceFilter('servicesTable', this.value, 'filterIcingaCount')">
  ...
  function refreshAlertsTable() {
    fetch('/history?limit=100', { credentials: 'include' }).then(function(r) {
      ...
      try {
        ...
        var html = '<div class="table-filter"><input type="text" id="filterAlerts" placeholder="Filter alerts..." oninput="debounceFilter(\'alertsTable\', this.value, \'filterAlertsCount\')"><span class="table-filter-count" id="filterAlertsCount"></span></div>';
...
// ── Table Filter ──
var _filterTimeouts = {};
function debounceFilter(tableId, query, countId) {
